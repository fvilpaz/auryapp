...
urlpatterns = [
    ...
    path('eventos/<int:pk>/restaurar/', views.restaurar_evento, name='restaurar_evento'),
    path('eventos/<int:pk>/eliminar-definitivo/', views.eliminar_evento_definitivo, name='eliminar_evento_definitivo'),
